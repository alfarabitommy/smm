        ...
        <div class="container pd-x-0">
          <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <div>
              ...
              <h4 class="mg-b-0 tx-spacing--1">Edit 'What's New' Article</h4>
            </div>
          </div>
          ...
          <div class="row row-xs">
            <div class="container">
              <p class="mg-b-30 col-md-8">Responsive is an extension for DataTables that resolves that problem by optimising the table's layout for different screen sizes through the dynamic insertion and removal of columns from the table.</p>
                ...
                <!-- start form -->
                <form action="<?= base_url(); ?>admin/proses_edit_videos" enctype="multipart/form-data" method="post" data-parsley-validate>
                <input type="hidden" name="id" value="<?= $data[0]['id'];?>">  
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input name="link" type="text" class="form-control" value="<?= $data[0]['link'];?>" required>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <button onClick="window.location='<?= base_url(); ?>admin/whatsnew/';" class="btn btn-secondary" type="cancel">Cancel</button>
                    </div>
                </form>
                <!-- end form -->
          </div><!-- row -->
