            ...
            <div class="container">
                ...
                <div class="blog-post date-style-1 blog-detail">
                    <div class="wt-post-media wt-img-effect">
                        <a href="javascript:void(0);"><img src="<?= base_url(); ?>assets/acnefacts/<?= $data[0]['image'];?>" alt="<?= $data[0]['title'];?>"></a>
                    </div>
                ...
                <div class="clear" id="comment-list">
                    <div class="comments-area" id="comments">
                        <h2 class="comments-title"> <?= count($comment); ?> Comments</h2>
                        <div class="p-tb30">
                            ...
                            <div class="comment-respond" id="respond">
                                ...
                                <form class="comment-form" id="commentform" method="post" action="<?= base_url('web/add_comment/'.$this->uri->segment(3));?>">
                                  <input type="hidden" name="type" value="acnefacts">
